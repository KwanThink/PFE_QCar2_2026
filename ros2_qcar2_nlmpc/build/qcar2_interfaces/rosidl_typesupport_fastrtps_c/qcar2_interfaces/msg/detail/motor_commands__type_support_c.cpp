...
#include "qcar2_interfaces/msg/detail/motor_commands__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // motor_names
#include "rosidl_runtime_c/string_functions.h"  // motor_names

// forward declare type support functions


using _MotorCommands__ros_msg_type = qcar2_interfaces__msg__MotorCommands;
...
size_t get_serialized_size_qcar2_interfaces__msg__MotorCommands(
  const void * untyped_ros_message,
...
static uint32_t _MotorCommands__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_qcar2_interfaces__msg__MotorCommands(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_qcar2_interfaces
size_t max_serialized_size_qcar2_interfaces__msg__MotorCommands(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = qcar2_interfaces__msg__MotorCommands;
    is_plain =
      (
...
static size_t _MotorCommands__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_qcar2_interfaces__msg__MotorCommands(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, qcar2_interfaces, msg, MotorCommands)() {
