...
def generate_launch_description():
    ...
    declare_use_namespace_cmd = DeclareLaunchArgument(
        'use_namespace',
        default_value='False',
        description='Whether to apply a namespace to the stack',
    )
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        ...
        description='Full path to the localization + navigation parameter file',
    )

    declare_autostart_cmd = DeclareLaunchArgument(
        'autostart',
        default_value='True',
        description='Automatically bring the Nav2 stack to the active state',
    )
    ...
    declare_use_rviz_cmd = DeclareLaunchArgument(
        'use_rviz',
        default_value='True',
        description='Launch RViz2 together with localization and navigation',
    )
    ...
    declare_use_composition_cmd = DeclareLaunchArgument(
        'use_composition',
        default_value='False',
        description='Whether to use composed bringup for the navigation stack',
    )
